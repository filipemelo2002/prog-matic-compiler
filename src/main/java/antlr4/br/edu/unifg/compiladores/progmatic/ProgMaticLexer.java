...
public class ProgMaticLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "INTEGER_LITERAL", "STRING_LITERAL", "CHAR_LITERAL", 
			"FLOAT_LITERAL", "BOOLEAN_LITERAL", "POINTER", "ADDRESS", "IDENTIFIER", 
			"SEMICOLON", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "COMMA", "ATTRIBUTION", 
