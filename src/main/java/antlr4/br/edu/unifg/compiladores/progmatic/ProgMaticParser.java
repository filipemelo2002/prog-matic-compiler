...
public class ProgMaticParser extends Parser {
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			case 11:
				...
				{
				setState(94);
				((StatementsContext)_localctx).inputStatement = inputStatement();
				((StatementsContext)_localctx).node =  ((StatementsContext)_localctx).inputStatement.node;
				}
				break;
			}
		}
	...
	public final InputStatementContext inputStatement() throws RecognitionException {
		...
		try {
			...
			match(LPAREN);
			setState(371);
			((InputStatementContext)_localctx).IDENTIFIER = match(IDENTIFIER);
			setState(372);
			match(RPAREN);
			setState(373);
			match(SEMICOLON);
			((InputStatementContext)_localctx).node =  new InputExpression((((InputStatementContext)_localctx).IDENTIFIER!=null?((InputStatementContext)_localctx).IDENTIFIER.getText():null));
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
