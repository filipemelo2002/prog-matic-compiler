...
public class ProgMaticParser extends Parser {
	...
	public static final int
		...
		RULE_loopDeclaraion = 10, RULE_logicalExpression = 11, RULE_logicalOrExpression = 12, 
		RULE_logicalAndExpression = 13, RULE_equalityExpression = 14, RULE_relationalExpression = 15, 
		RULE_additiveExpression = 16, RULE_multiplicativeExpression = 17, RULE_unaryExpression = 18, 
		RULE_primaryExpression = 19, RULE_logicalNotExpression = 20, RULE_parameterList = 21, 
		RULE_parameter = 22, RULE_inputStatement = 23;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ifDeclaration", "loopDeclaraion", "logicalExpression", "logicalOrExpression", 
			"logicalAndExpression", "equalityExpression", "relationalExpression", 
			"additiveExpression", "multiplicativeExpression", "unaryExpression", 
			"primaryExpression", "logicalNotExpression", "parameterList", "parameter", 
			"inputStatement"
		};
	}
	...
	public final LoopDeclaraionContext loopDeclaraion() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_loopDeclaraion);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final LogicalNotExpressionContext logicalNotExpression() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_logicalNotExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(292);
