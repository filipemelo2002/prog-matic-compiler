...
public class ProgMaticParser extends Parser {
	...
	public static final int
		...
		RULE_procedureDeclaration = 7, RULE_parameterList = 8, RULE_parameter = 9, 
		RULE_procedureCall = 10, RULE_argumentList = 11, RULE_ifDeclaration = 12, 
		RULE_loopDeclaraion = 13, RULE_logicalExpression = 14, RULE_logicalOrExpression = 15, 
		...
		RULE_primaryExpression = 22, RULE_logicalNotExpression = 23, RULE_inputStatement = 24;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statements", "printStatement", "variableDeclaration", "attribution", 
			"pointerDeclaration", "pointerAttribution", "procedureDeclaration", "parameterList", 
			"parameter", "procedureCall", "argumentList", "ifDeclaration", "loopDeclaraion", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 65786L) != 0)) {
				{
				{
				setState(51);
	...
	public final IfDeclarationContext ifDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_ifDeclaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final LoopDeclaraionContext loopDeclaraion() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_loopDeclaraion);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
